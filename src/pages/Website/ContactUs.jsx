...
const ContactUs = () => {
  ...
  return (
    <WebsiteLayout>
      <AosWrapper>
        <div className="container_custom terms_data z-1">
          <div class=" max-w-6xl mx-auto relative rounded-lg py-6 mt-16">
            <div class="grid lg:grid-cols-3 items-center">
              ...
              <div class="lg:col-span-2 bg-[var(--primary-color)] rounded-lg sm:p-10 p-4 z-10 max-lg:-order-1 max-lg:mb-8">
                <h2 class="text-3xl text-white text-center font-bold mb-6 uppercase">
                  Contact us
                </h2>
                <form>
                  <div class="max-w-md mx-auto space-y-3">
                    ...
                    <textarea
                      placeholder="Message"
                      rows="6"
                      class="w-full bg-gray-100 rounded-lg px-6 text-sm pt-3 outline-none text-black"
                    ></textarea>
                    <button
                      type="button"
                      class="w-full relative bg-[#202020] text-white hover:bg-white hover:text-black font-semibold rounded-lg text-sm px-6 py-3 !mt-6"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16px"
